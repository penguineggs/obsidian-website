...
let osDownloadInfo = {
	'Windows': {
		...
		downloadLink: 'https://github.com/obsidianmd/obsidian-releases/releases/download/v0.8.12/Obsidian.0.8.12.exe'
	},
	'MacOS': {
		buttonName: 'macOS',
		descriptionName: 'macOS',
		downloadLink: 'https://github.com/obsidianmd/obsidian-releases/releases/download/v0.8.12/Obsidian-0.8.12.dmg',
	},
	'Linux': {
		buttonName: 'Linux',
		descriptionName: 'Linux (AppImage)',
		downloadLink: 'https://github.com/obsidianmd/obsidian-releases/releases/download/v0.8.12/Obsidian-0.8.12.AppImage'
	},
	'Linux-Snap': {
		buttonName: 'Linux',
		descriptionName: 'Linux (Snap)',
		downloadLink: 'https://github.com/obsidianmd/obsidian-releases/releases/download/v0.8.12/obsidian_0.8.12_amd64.snap'
	}
};
